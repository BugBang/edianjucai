...
<head>
    <meta charset="UTF-8">
    <link rel="stylesheet" type="text/css" href="../static/css/jifen_fenleilist.css">
    <link rel="stylesheet" href="../static/js/jquery-ui.css">
    <script type="text/javascript" src="../static/js/jquery-1.12.2.min.js"></script>
    <script src="../static/js/jquery-ui.js"></script>
    <script type="text/javascript" src="../static/js/jifen_fenleilist.js"></script>
</head>
...
<body>
    <div class="sheet">
        ...
        <div class="list">
            ...
            <div class="list_top">
                <button class="btn btn1" onclick="goToAddGoodsCate('<%=url%>')">新增</button>
            ...
            <div class="list_bottom">
                <a href="<%=url%>/Business/showAllGoodsCate?currentPage=1" class="a_0 a_1"></a>
                <c:if test="${pagination.currentPage <= 1 }">
                    <a href="<%=url%>/Business/showAllGoodsCate?currentPage=1" class="a_0 a_2"></a>
                </c:if>
                <c:if test="${pagination.currentPage > 1 }">
                    <a href="<%=url%>/Business/showAllGoodsCate?currentPage=${(pagination.currentPage - 1)}" class="a_0 a_2"></a>
                </c:if>
                <div class="page_1">第<input type="text" value="${pagination.currentPage }" class="page_inp page_inp1">页</div>
                <c:if test="${pagination.currentPage >= pagination.totalPage}">
                    <a href="<%=url%>/Business/showAllGoodsCate?currentPage=${(pagination.totalPage)}" class="a_0 a_3"></a>
                </c:if>
                <c:if test="${pagination.currentPage < pagination.totalPage}">
                    <a href="<%=url%>/Business/showAllGoodsCate?currentPage=${(pagination.currentPage + 1)}" class="a_0 a_3"></a>
                </c:if>
                <a href="<%=url%>/Business/showAllGoodsCate?currentPage=${pagination.totalPage }" class="a_0 a_4"></a>
                ...
                <input type="button" value="GO" class="page_inp" onclick="tiaozhuan('<%=url%>/Business/showAllGoodsCate')"/>
            </div>
        </div>
