						...
						<table>
							<tr>
								<td colspan="2">
									<div class="box box2">
										文章标题 :
										<input type="text" value="${article.title }" name="title"  placeholder="必填" dir="rtl" class="input input2">
									</div>
								</td>
							</tr>
							<tr>
								<td colspan="2">
									<div>
										<div class="box box4">
											图标 :
											<input type="text" name="icon" dir="rtl" class="input" value = "${article.icon }">
							...
							<tr>
								<td>
									<div class="box box1">
										URL别名 :
										<input type="text" value = "${article.relUrl }" name="relUrl" placeholder="请输入" dir="rtl" class="input input3">
									</div>
								</td>
								<td>
									<div class="box box1">
							...
							<tr>
								<td>
									<div class="box box1">
										分类 :
										<input type="text" value = "${article.cateId }" name="cateId" dir="rtl" placeholder="必填" class="input input4 input_drop" readonly="readonly">
								...
								<td>
									<div class="box box1">
										状态 :
										<input type="text" value = "${articles.isEffect == 0 ? '无效' : '有效'}" name="isEffect" dir="rtl" placeholder="必填" class="input input4 input_drop" readonly="readonly">
							...
							<tr>
								<td colspan="2">
									<div class="box5">
										...
										<textarea placeholder="${article.seoTitle }"></textarea>
									</div>
								</td>
							</tr>
							<tr>
								<td colspan="2">
									<div class="box5">
										...
										<textarea placeholder="${article.seoKeyword }"></textarea>
									</div>
								</td>
							</tr>
							<tr>
								<td colspan="2">
									<div class="box5">
										...
										<textarea placeholder="${article.seoDescription }"></textarea>
									</div>
								</td>
							</tr>
						</table>
