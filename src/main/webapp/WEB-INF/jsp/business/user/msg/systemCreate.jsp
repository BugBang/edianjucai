...
<body>
    ...
    <h2>create msg system</h2>
    <h3>${addMsg }</h3>
    <form action="<%=request.getContextPath()%>/Business/addMsgSystem" method="get">
...
<body>
    <div class="sheet">
        ...
        <div class="list">
            ...
            <div class="sign_all">
                <ul class="sign_title">
                    <li><a href="userManager_userAdd.html">会员管理</a></li>
                    <li><a href="#">银行卡管理</a></li>
                    <li><a href="userManager_HBlist.html">红包管理</a></li>
                    <li style="border-right: none;" id="title_bg"><a href="#">站内消息管理</a></li>
                    <div class="clear"></div>
                </ul>
            </div>
            <div class="sign_all">
